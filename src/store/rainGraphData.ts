export interface RainVertexData {
    id: string;
  ...
  export interface RainEdgeData {
    id: string;
    from: string;
    to: string;
  }
  export interface RainGraphData {
    vertices: RainVertexData[];
    edges: RainEdgeData[];
  }
  export const rainGraphData: RainGraphData  = {
    vertices: [
      //visible for change position, green color base on map sample
      { id: "v1", objectName: null, cx: 798.5, cy: 1138.49 ,r:15,categoryName: "null"},//Front Entrance
      //PTC BUILDING
    ...
    //   { id: "v228_to_v208", from: "v228", to: "v208" },
      { id: "v228_to_v153", from: "v228", to: "v153" },
      //4 wheel p1
    ...
    //   { id: "v91_to_v149", from: "v91", to: "v149" },
      ...
      { id: "v117_to_v235", from: "v117", to: "v235" },
      ...
      { id: "v151_to_v152", from: "v151", to: "v152" },
      //mba 1
